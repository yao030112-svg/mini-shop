...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"迷你商城","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var _user = _interopRequireDefault(__webpack_require__(/*! ./modules/user */ 39));
var _cart = _interopRequireDefault(__webpack_require__(/*! ./modules/cart */ 45));
...
var _default = {
  ...
  mutations: {
    ...
    SET_TOTAL_PRICE: function SET_TOTAL_PRICE(state, price) {
      state.totalPrice = price;
    },
    SET_SELECTED_COUNT: function SET_SELECTED_COUNT(state, count) {
  ...
  actions: {
    ...
    getCartList: function getCartList(_ref) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var commit, res, _res$data, cartList, totalPrice, selectedCount;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 3:
                res = _context.sent;
                _res$data = res.data, cartList = _res$data.cartList, totalPrice = _res$data.totalPrice;
                commit('SET_CART_LIST', cartList || []);
                commit('SET_TOTAL_PRICE', totalPrice || 0);
                // 计算选中数量
                selectedCount = (cartList || []).filter(function (item) {
     ...
     */
    addToCart: function addToCart(_ref2, skuId) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
        var dispatch, res;
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
    ...
    updateQuantity: function updateQuantity(_ref3, _ref4) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
        var dispatch, id, quantity, res;
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                dispatch = _ref3.dispatch;
                id = _ref4.id, quantity = _ref4.quantity;
                _context3.next = 4;
                return (0, _cart.updateQuantity)(id, quantity);
              case 4:
                res = _context3.sent;
                _context3.next = 7;
                return dispatch('getCartList');
     ...
     */
    deleteItem: function deleteItem(_ref5, id) {
     ...
     */
    toggleSelectAll: function toggleSelectAll(_ref6, selected) {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 3;
                return (0, _cart.selectAll)(selected);
              case 3:
                res = _context5.sent;
                _context5.next = 6;
                return dispatch('getCartList');
     ...
     */
    toggleSelect: function toggleSelect(_ref7, _ref8) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6() {
        var dispatch, id, selected, res;
        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                dispatch = _ref7.dispatch;
                id = _ref8.id, selected = _ref8.selected;
                _context6.next = 4;
                return (0, _cart.toggleSelect)(id, selected);
              case 4:
                res = _context6.sent;
                _context6.next = 7;
                return dispatch('getCartList');
...
function getCartList() {
  return (0, _request.get)('/api/cart/list');
}
...
function addToCart(skuId) {
  return (0, _request.post)('/api/cart/add', {
    skuId: skuId
  });
}
...
function updateQuantity(id, quantity) {
  return (0, _request.put)('/api/cart/update', {
    id: id,
    quantity: quantity
  });
}
...
function deleteItem(id) {
  return (0, _request.del)("/api/cart/delete/".concat(id));
}
...
function selectAll(selected) {
  return (0, _request.put)('/api/cart/select-all', {
    selected: selected
  });
}
...
function toggleSelect(id, selected) {
  return (0, _request.put)("/api/cart/select/".concat(id), {
    selected: selected
  });
}
...
function getHotProducts() {
  return (0, _request.get)('/api/product/hot');
}
...
function getProductList() {
  ...
  return (0, _request.get)('/api/product/list', {
    page: page,
    pageSize: pageSize
  });
}
...
function getProductDetail(id) {
  return (0, _request.get)("/api/product/".concat(id));
}
...
function getProductsByCategory(categoryId) {
  ...
  return (0, _request.get)("/api/product/category/".concat(categoryId), {
    page: page,
    pageSize: pageSize
  });
}
...
function getBannerList() {
  return (0, _request.get)('/api/banner/list');
}
...
function getCategoryList() {
  return (0, _request.get)('/api/category/list');
}
...
function getAddressList() {
  return (0, _request.get)('/api/address/list');
}
...
function addAddress(data) {
  return (0, _request.post)('/api/address/add', data);
}
...
function updateAddress(data) {
  return (0, _request.put)('/api/address/update', data);
}
...
function deleteAddress(id) {
  return (0, _request.del)("/api/address/delete/".concat(id));
}
...
function setDefault(id) {
  return (0, _request.put)("/api/address/default/".concat(id));
}
...
function createOrder(addressId) {
  return (0, _request.post)('/api/order/create', {
    addressId: addressId
  });
}
...
function payOrder(id) {
  return (0, _request.post)("/api/order/pay/".concat(id));
}
...
function getOrderList(status) {
  ...
  return (0, _request.get)('/api/order/list', params);
}
...
function getOrderDetail(id) {
  return (0, _request.get)("/api/order/".concat(id));
}
...
function cancelOrder(id) {
  return (0, _request.post)("/api/order/cancel/".concat(id));
}
...
function getProductList() {
  var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
  var pageSize = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 20;
  return (0, _request.get)('/api/admin/product/list', {
    page: page,
    pageSize: pageSize
  });
}
...
function addProduct(data) {
  return (0, _request.post)('/api/admin/product/add', data);
}
...
function updateProduct(data) {
  return (0, _request.put)('/api/admin/product/update', data);
}
...
function deleteProduct(id) {
  return (0, _request.del)("/api/admin/product/delete/".concat(id));
}
...
function updateProductStatus(id, status) {
  return (0, _request.put)("/api/admin/product/status/".concat(id), {
    status: status
  });
}
 ...
 */
function getCategoryList() {
  return (0, _request.get)('/api/admin/category/list');
}
...
function addCategory(data) {
  return (0, _request.post)('/api/admin/category/add', data);
}
...
function updateCategory(data) {
  return (0, _request.put)('/api/admin/category/update', data);
}
...
function deleteCategory(id) {
  return (0, _request.del)("/api/admin/category/delete/".concat(id));
}
...
function getCategoryProducts(categoryId) {
  return (0, _request.get)("/api/admin/category/products/".concat(categoryId));
}
 ...
 */
function getBannerList() {
  return (0, _request.get)('/api/admin/banner/list');
}
...
function addBanner(data) {
  return (0, _request.post)('/api/admin/banner/add', data);
}
...
function updateBanner(data) {
  return (0, _request.put)('/api/admin/banner/update', data);
}
...
function deleteBanner(id) {
  return (0, _request.del)("/api/admin/banner/delete/".concat(id));
}
 ...
 */
function toggleBannerStatus(id, status) {
  return (0, _request.put)("/api/admin/banner/status/".concat(id), null, {
    params: {
      status: status
    }
  });
...
function getOrderList(status, userId) {
  ...
  return (0, _request.get)('/api/admin/order/list', params);
}
 ...
 */
function getOrderDetail(id) {
  return (0, _request.get)("/api/admin/order/detail/".concat(id));
}
...
function shipOrder(id) {
  return (0, _request.put)("/api/admin/order/ship/".concat(id));
}
...
function refundOrder(id) {
  return (0, _request.put)("/api/admin/order/refund/".concat(id));
}
...
function getUserList() {
  return (0, _request.get)('/api/admin/user/list');
}
...
function disableUser(id) {
  return (0, _request.put)("/api/admin/user/disable/".concat(id));
}
...
function enableUser(id) {
  return (0, _request.put)("/api/admin/user/enable/".concat(id));
}
